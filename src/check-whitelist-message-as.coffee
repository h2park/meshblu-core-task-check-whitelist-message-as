...
class CheckWhitelistMessageAs
  ...
  do: (job, callback) =>
    ...
    emitter = fromUuid
    subscriber = toUuid
    return @sendResponse responseId, 403, callback unless fromUuid == auth.as
    @whitelistManager.checkMessageAs {emitter, subscriber}, (error, verified) =>
...
module.exports = CheckWhitelistMessageAs
